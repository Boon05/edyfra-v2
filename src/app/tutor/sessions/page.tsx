         ...
         {activeTab === "active" ? (
             ...
             <Card key={session.id} className="border-border bg-card/50 hover:bg-secondary/30 transition-all rounded-[3rem] overflow-hidden group">
               <CardContent className="p-0 flex flex-col lg:flex-row">
                  <div className="lg:w-72 bg-secondary/30 p-10 flex flex-col items-center justify-center border-b lg:border-b-0 lg:border-r border-border">
                     ...
                     <p className="text-xl font-black text-center tracking-tight">{session.student}</p>
                  ...
                  <div className="flex-1 p-10 flex flex-col md:flex-row items-center justify-between gap-10">
                     <div className="space-y-6">
                        <div className="flex items-center gap-3">
                           <Badge className="bg-emerald-500/10 text-emerald-500 border-none text-[9px] font-black uppercase tracking-widest px-3 py-1">Ready to Start</Badge>
                        ...
                        <div className="space-y-2">
                           ...
                           <div className="flex flex-wrap items-center gap-6 text-sm font-bold text-muted-foreground">
                              <span className="flex items-center gap-2"><Clock className="h-4 w-4 text-primary" /> {session.time}</span>
                              <span className="flex items-center gap-2"><Calendar className="h-4 w-4 text-primary" /> {session.duration}</span>
                           </div>
                        </div>
                     </div>
                     ...
                     <div className="flex items-center gap-4 w-full md:w-auto">
                        ...
                        <Button className="flex-1 md:flex-none h-16 px-10 rounded-2xl bg-primary hover:bg-primary/90 text-white font-black text-xs tracking-widest uppercase shadow-xl shadow-primary/20 transition-all active:scale-95 group">
           ...
           <div className="p-32 flex flex-col items-center justify-center text-center space-y-6 bg-secondary/30 rounded-[4rem] border border-dashed border-border">
              ...
              <div className="space-y-2">
                 ...
                 <p className="text-muted-foreground font-medium max-w-xs mx-auto">Your completed teaching sessions will be archived here.</p>
              </div>
           </div>
         )}
      </div>
