...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#050505] text-white selection:bg-primary/30">
      ...
      <div className="h-8 bg-black border-b border-white/5 flex items-center justify-between px-6 text-[8px] font-black uppercase tracking-[0.3em] z-[60] relative">
      ...
      <div className="flex flex-1">
        {/* Sleek Glass Sidebar */}
        <aside className="w-72 bg-black/40 backdrop-blur-2xl border-r border-white/5 flex flex-col fixed top-8 bottom-0 z-50">
        ...
        <main className="flex-1 ml-72 bg-gradient-to-br from-[#050505] to-[#0a0a0a]">
          <header className="h-20 bg-black/40 backdrop-blur-md border-b border-white/5 flex items-center justify-between px-10 sticky top-8 z-40">
